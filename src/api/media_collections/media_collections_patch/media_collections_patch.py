...
from src.api.media_collections.docs.media_collections_patch_docs import (
    summary_media_colllections_patch,
    description_media_colllections_patch,
    response_description_media_colllections_patch,
)
...
@router.patch(
    "/{media_id}",
    summary=summary_media_colllections_patch,
    description=description_media_colllections_patch,
    response_description=response_description_media_colllections_patch
)
async def media_collections_patch(media_id: int, data: MediaCollectionRequestBody):
    try:
        ...
        status, message = media.get_media(media_id=media_id)
