...
from src.api.media_collections.docs.media_collections_get_docs import (
    summary_media_colllections_get,
    description_media_colllections_get,
    response_description_media_colllections_get,
)
...
@router.get(
    "/{media_id}",
    summary=summary_media_colllections_get,
    description=description_media_colllections_get,
    response_description=response_description_media_colllections_get,
